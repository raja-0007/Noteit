...
function Editnote({ edit_note }) {
  ...
  function editnotes() {
    console.log(content)
    edit_note(location.state.item._id, title, content,clr)
  }
  useEffect(()=>{
    ...
    <div className='notelayout'>
      ...
      <div className='noteinputs' id='noteinputs'>
        <span className='inputspan'>
          ...
          <Link to={'/noteslist'}><button className='donebtn' onClick={editnotes}><label><i class="fa-solid fa-check"></i></label></button></Link>
        </span>
